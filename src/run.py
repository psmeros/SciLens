...
#compute_pairs_similarity(cache_dir + 'similarity_model_pairs_v1.tsv', cache_dir + 'article_details_v5.tsv', cache_dir + 'paper_details_v3.tsv', 'full_text', cache_dir + 'similarity_model_pairs_v2.tsv')
