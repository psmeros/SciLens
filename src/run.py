...
from matching import prepare_articles_matching, compute_pairs_similarity, uniformly_random_subsample
...
compute_pairs_similarity(cache_dir + 'pairs_v1.tsv', cache_dir + 'article_details_v3.tsv', cache_dir + 'paper_details_v3.tsv', cache_dir + 'pairs_v2.tsv')
