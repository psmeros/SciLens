...
#compute_pairs_similarity(cache_dir + 'similarity_model_pairs_v1.tsv', cache_dir + 'article_details_v5.tsv', cache_dir + 'paper_details_v3.tsv', cache_dir + 'similarity_model_pairs_v2.tsv')
compute_similarity_model(cache_dir+'similarity_model_pairs_v2.tsv', cache_dir+'rf_model.sav', False)
