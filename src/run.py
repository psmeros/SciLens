...
#create_annotation_subsample(diffusion_graph_dir+'article_pairs.tsv', 'cache/article_details_v3.tsv', 'cache/paper_details_v3.tsv', 1000, 'cache/par_pairs_v1.tsv')
uniformly_random_subsample('cache/par_pairs_v1.tsv', 200, 'cache/par_pairs_v2.tsv')
