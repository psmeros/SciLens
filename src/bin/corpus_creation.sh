...
psql -U $user -d $db -h $host -c "\copy (select url, body as tweet, publishing_date, base_popularity, retweet_count, user_country from document where doc_type = 'twitter' $limit ) TO $tmpfolder$twitterfile;"
