...
#extend tweet details with tweets' and replies' sentiment, user features and replies' stance
def extent_tweet_details(tweets_in_file, tweets_out_file):
    tweet_details = pd.read_csv(tweets_in_file, sep='\t')
    ...
    tweet_details.to_csv(tweets_out_file, sep='\t', index=None)
